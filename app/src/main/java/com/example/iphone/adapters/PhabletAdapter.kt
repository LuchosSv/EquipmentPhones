...
class PhabletAdapter (private val phablet: ArrayList<EquipmentDetail>, private val listener: OnClickListener) :
    RecyclerView.Adapter<PhabletAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bindData(phablet[position])
    }
